...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> POKER_CHIP_BLOCK = registerBlock("poker_chip_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(4f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));
    public static final RegistryObject<Block> CHIP_BLOCK = registerBlock("chip_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(4f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));
